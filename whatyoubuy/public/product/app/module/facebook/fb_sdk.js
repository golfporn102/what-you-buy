/*1421900363,,JIT Construction: v1570531,en_US*/
...
try {
            ...
            var w = m.extend({
                ...
                x = {
                    ...
                    create: function(y) {
                        ...
                        } else ba += n.mobile() ? ' fb_dialog_mobile' : ' fb_dialog_advanced'; if (y.content) h.append(y.content, aa);
                        z.className = ba;
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "guid", "resolveURI"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
            ...
            var fa = p.extend({
                constructor: function(ga, ha, ia, ja) {
                    ...
                    if (q.mobile()) na.container_width = ga.offsetWidth;
                    h.addCss(ga, 'fb_iframe_widget');
                    if (this.isFluid()) h.addCss(ga, 'fb_iframe_widget_fluid_desktop');
                    var oa = v();
                    ...
                    if (na.allowfullscreen) this._iframeOptions.allowfullscreen = true;
                },
                process: function() {
                    if (o.getIsVersioned()) {
                    ...
                    if (q.mobile()) {
                        ...
                        if (!this._iframeOptions.width) {
                            ...
                            if (q.iphone() || q.ipad()) ES('Object', 'assign', false, ka, {
                                width: '220px',
                                'min-width': '100%'
                            });
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1570531","message":"' + e.message + '"}}');
}